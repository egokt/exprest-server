...
): (req: express.Request, res: express.Response<OTHER_DATA extends never ? SuccessfulEntityResponse<FRONT_END_ENTITY> : SuccessfulEntityResponseWithOtherData<FRONT_END_ENTITY, OTHER_DATA>>) => Promise<void> {
